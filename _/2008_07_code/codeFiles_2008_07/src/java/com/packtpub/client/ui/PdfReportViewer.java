...
class PdfReportViewer extends FormPanel
{
    ...
    public PdfReportViewer(String fileName, HashMap<String, Integer> param, String title)
    {
        ...
        ((GWTServiceAsync) GWT.create(GWTService.class)).getPdfReport(fileName, param, reportURLCallback);
